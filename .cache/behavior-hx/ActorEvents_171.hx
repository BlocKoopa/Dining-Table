				...
				if((((Engine.engine.getGameAttribute("Answered8") : Bool) == false) && ((Engine.engine.getGameAttribute("Answered9") : Bool) == false)))
				{
					if(((Engine.engine.getGameAttribute("Correct_3") : Bool) == false))
					{
						if(((Engine.engine.getGameAttribute("QuestionMenuLv1") : Bool) == false))
						{
							...
							{
								createRecycledActor(getActorType(173), 800, 50, Script.FRONT);
								runLater(1000 * 0.5, function(timeTask:TimedTask):Void
								{
									createRecycledActor(getActorType(175), 800, 150, Script.FRONT);
									runLater(1000 * 0.5, function(timeTask:TimedTask):Void
									{
										createRecycledActor(getActorType(177), 800, 250, Script.FRONT);
										runLater(1000 * 0.5, function(timeTask:TimedTask):Void
										{
											createRecycledActor(getActorType(179), 800, 350, Script.FRONT);
										}, actor);
									}, actor);
								}, actor);
							}, actor);
