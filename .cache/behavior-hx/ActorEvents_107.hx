				...
				if((((Engine.engine.getGameAttribute("Answered19") : Bool) == false) && ((Engine.engine.getGameAttribute("Answered21") : Bool) == false)))
				{
					if(((Engine.engine.getGameAttribute("QuestionMenuLv1") : Bool) == false))
					{
						if(((Engine.engine.getGameAttribute("Correct_7") : Bool) == false))
						{
							...
							actor.growTo(120/100, 120/100, 0, Easing.linear);
				...
				if((((Engine.engine.getGameAttribute("Answered19") : Bool) == false) && ((Engine.engine.getGameAttribute("Answered21") : Bool) == false)))
				{
					if(((Engine.engine.getGameAttribute("Correct_7") : Bool) == false))
					{
						if(((Engine.engine.getGameAttribute("QuestionMenuLv1") : Bool) == false))
						{
							...
							{
								createRecycledActor(getActorType(111), 800, 50, Script.FRONT);
								runLater(1000 * 0.5, function(timeTask:TimedTask):Void
								{
									createRecycledActor(getActorType(113), 800, 150, Script.FRONT);
									runLater(1000 * 0.5, function(timeTask:TimedTask):Void
									{
										createRecycledActor(getActorType(115), 800, 250, Script.FRONT);
										runLater(1000 * 0.5, function(timeTask:TimedTask):Void
										{
											createRecycledActor(getActorType(117), 800, 350, Script.FRONT);
										}, actor);
									}, actor);
								}, actor);
							}, actor);
