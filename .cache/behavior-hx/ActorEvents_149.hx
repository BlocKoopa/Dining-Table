...
class ActorEvents_149 extends ActorScript
{
	...
	override public function init()
	{
		...
		addMouseOverActorListener(actor, function(mouseState:Int, list:Array<Dynamic>):Void
		{
			...
			{
				if((((Engine.engine.getGameAttribute("Answered4") : Bool) == false) && ((Engine.engine.getGameAttribute("Answered6") : Bool) == false)))
				{
				...
				if(((Engine.engine.getGameAttribute("QuestionMenuLv1") : Bool) == true))
				{
					if(((Engine.engine.getGameAttribute("Answered4") : Bool) == true))
					{
						runLater(1000 * 2, function(timeTask:TimedTask):Void
						{
							...
							actor.moveTo(484, 245, 0.5, Easing.linear);
				...
				if((((Engine.engine.getGameAttribute("Answered4") : Bool) == false) && ((Engine.engine.getGameAttribute("Answered6") : Bool) == false)))
				{
					if(((Engine.engine.getGameAttribute("Correct_1") : Bool) == false))
					{
						if(((Engine.engine.getGameAttribute("QuestionMenuLv1") : Bool) == false))
						{
							...
							{
								createRecycledActor(getActorType(163), 800, 50, Script.FRONT);
								runLater(1000 * 0.5, function(timeTask:TimedTask):Void
								{
									createRecycledActor(getActorType(169), 800, 150, Script.FRONT);
									runLater(1000 * 0.5, function(timeTask:TimedTask):Void
									{
										createRecycledActor(getActorType(167), 800, 250, Script.FRONT);
										runLater(1000 * 0.5, function(timeTask:TimedTask):Void
										{
											createRecycledActor(getActorType(165), 800, 350, Script.FRONT);
										}, actor);
									}, actor);
								}, actor);
							}, actor);
